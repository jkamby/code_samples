...
--added table for generating ids-- nit used any more. Left here for backward compatibility.
...
-- INSERT INTO MUSIC_ID_GEN (GEN_NAME, GEN_VAL) values ('MenuToppingId_Gen', 0);
